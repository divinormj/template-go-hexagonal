// Package mongodb provides the implementation of the Gateways interface using MongoDB.
package mongodb
...
// EntityRepository provides methods to interact with the MongoDB collection.
